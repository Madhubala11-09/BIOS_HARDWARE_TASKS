...
here 733 is the ECU ID, 22 is the service id it is known as read data by identifier service, and F190 is the identfier for VIN of a vehicle used in uds. When I sent this command it gave 
...
Here 10 14 62 F1 90 4C 55 41 the first three nibbles are data length, 62 is 22 +8 gives 62 a service id. F1 90 specifies it is giving the VIN number, the last three are the first three bytes of the VIN number. Next we give a cansend command 
